...
// picture underneath (see _paintOverlays in core/mol.js). It now reports
...
// Use getStandardResidueName if available (from src/io/parse.js), otherwise use local mapping
