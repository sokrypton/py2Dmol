...
(function () {
    ...
    class ScatterPlotViewer {
        constructor(canvas, mainRenderer) {
            ...
            this.paddingLeft = 40 * this.scale;   // Y-axis labels and ticks
            this.paddingRight = 15 * this.scale;  // Prevent label cutoff
            this.paddingTop = 8 * this.scale;     // Prevent label cutoff
            this.paddingBottom = 35 * this.scale; // X-axis labels and ticks
            this.plotWidth = 0;
            this.plotHeight = 0;
        ...
        drawAxes() {
            ...
            ctx.fillText(this.xLabel, this.paddingLeft + this.plotWidth / 2, height - this.paddingBottom * 0.2);

            // Y-axis label (rotated, positioned relative to left padding)
            ctx.save();
            ctx.translate(this.paddingLeft * 0.15, this.paddingTop + this.plotHeight / 2);
