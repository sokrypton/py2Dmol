...
if [[ "$LANE" == "all" || "$LANE" == "ui" ]]; then
  UI=(pick_empty selection_mark richardson_tint focus_mode hover_echo heatmap_objects heatmap_visibility hidden_reload cut_ligands
